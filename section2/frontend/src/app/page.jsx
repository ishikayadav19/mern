  ...
  return (
    <div>
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
              ...
              <div className="relative ms-4">
                <img
                  ...
                  alt="Hero Image"
                />
                <div className="absolute inset-0 -z-1 bg-linear-to-tr from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6" />
                {/* SVG*/}
      ...
      <Card
        ...
        description="my card description 2"
        primaryText="Save"
        secondaryText="Cancel"
      />
      <Card
        title="my card title 3"
        description="my card description 3"
        primaryText="Save"
        secondaryText="Cancel"
      />
      <Card
        title="my card title 4"
        description="my card description 4"
        primaryText="Save"
        secondaryText="Cancel"
      />
